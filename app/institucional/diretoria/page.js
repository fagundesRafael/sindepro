            ...
            <main className="flex-grow mx-[10%] py-4">
                <div className="container mx-auto px-4">
                    ...
                    <section className="mb-6 bg-gray-50 rounded-lg p-8 shadow"> {/* Increased bottom margin */}
                        <h2 className="text-2xl font-bold text-red-700 mb-4 text-center">DIRETORIA ATUAL SINDEPRO (2023/2026)</h2> {/* Increased bottom margin */}

                        <div className=" text-slate-700 max-w-3xl mx-auto">
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Presidente:</span> <span>Dr Mário Jorge Pinto Sobrinho</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Vice-Presidente:</span> <span>Dr Cristiano Lopes Ferreira</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Secretário Geral:</span> <span>Dr Marcos Correia</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Tesoureiro:</span> <span>Dra Janaína Xander Wessel</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Relações Intersindicais:</span> <span>Dr Júlio Cesar de Souza Ferreira</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Diretor de Esportes e Cultura:</span> <span>Dr Ronicir Manfroi</span></p>
                            <p className="flex mb-1"><span className="font-bold w-56 flex-shrink-0">Diretor de Relações Públicas:</span> <span>Dr Fábio Henrique Fernandes de Campos</span></p>
                    ...
                    <div className="space-y-4"> {/* Adiciona espaço entre os elementos <details> */}
                      ...
                      <details className="bg-white p-4 rounded-lg shadow group"> {/* Adicionado group para possível estilização open: */}
                        ...
                        {/* Histórico Intro */}
                         <div className="mt-6 text-slate-700 max-w-3xl mx-auto text-center"> {/* Increased top margin */}
